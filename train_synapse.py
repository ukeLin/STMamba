...
class Synapse(L.LightningModule):
    ...
    def prepare_data(self) -> None:
        ...
        self.train_dataset = SynapseDataset(
            base_dir="/root/autodl-tmp/data/Synapse/train_npz",
            split="train",
            norm_x_transform=self.norm_x_transform,
            norm_y_transform=transforms.ToTensor(),
        )

        self.val_dataset = SynapseDataset(base_dir="/root/autodl-tmp/data/Synapse/test_vol_h5", split="test_vol")
